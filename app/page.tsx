...
export default function HomePage() {
  return (
    <>
      <Head>
        <title>Harshit Lodhi | Full-Stack Developer Portfolio</title>
        <meta
          name="description"
          content="Full-Stack Developer specializing in React, Next.js, and AI/ML. Building smart and scalable applications."
        />
      ...
      {(process.env.NODE_ENV === "development" || process.env.VERCEL_ENV === "preview") && (
        <Script
          ...
          data-recording-token="hq71y7NkM9cj5k9bxLWWESm5oDzDV0cTaS0LbYL4"
